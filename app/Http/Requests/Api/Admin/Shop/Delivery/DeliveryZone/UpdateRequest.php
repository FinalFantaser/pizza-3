...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'code' => 'required|string|size:6|unique:delivery_zones,code,'.$this->delivery_zone->code,
            'name' => 'required|string|max:512|unique:delivery_zones,name,'.$this->delivery_zone->name,
